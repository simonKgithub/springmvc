...
public class RequestParamController {
     ...
     * - 파라미터 이름으로 바인딩
     * @ResponseBody 추가
     * - View 조회를 무시하고, HTTP message body 에 직잡 해당 내용 입력
     */
    @ResponseBody
    ...
    /**
     * @RequestParam 사용
     * String, int 등의 단순 타입이면 @RequestParam 까지도 생략 가능
     */
    @ResponseBody
     ...
     * <p>
     * 참고: defaultValue는 빈 문자의 경우에도 적용한다.
     ...
     * argument resolver 로 저장해둔 타입 외 = @ModelAttribute
     */
    @ResponseBody
